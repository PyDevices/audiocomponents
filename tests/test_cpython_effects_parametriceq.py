...
from audioeffects.rebuilt import parametriceq          # noqa: E402
...
class SurfaceTest(unittest.TestCase):
    def test_the_declared_shape_is_what_the_class_builds(self):
        effect = audioeffects.create('ParametricEQ', source(), SAMPLE_RATE)
    ...
    def test_a_span_above_nyquist_clamps_rather_than_refuses(self):
        ...
        effect = audioeffects.create('ParametricEQ', low, 22050,
...
class TailTest(unittest.TestCase):
    ...
    def test_the_worst_section_reaches_exact_zero(self):
        effect = audioeffects.create(
            'ParametricEQ', burst_then_silence(), SAMPLE_RATE,
            **self.SETTINGS)
        self.addCleanup(effect.deinit)
...
class LowNetworksTest(unittest.TestCase):
    ...
    def build(self):
        return audioeffects.create('ParametricEQ', source(), SAMPLE_RATE,
