...
from audioeffects import noisegate as noisegate_module  # noqa: E402
from audioeffects.noisegate import NoiseGate         # noqa: E402
...
class TheRegistryServesIt(unittest.TestCase):
    ...
    def test_the_old_family_module_is_gone(self):
        with self.assertRaises(ImportError):
            __import__("audioeffects.dynamics")
