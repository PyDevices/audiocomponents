...
The dossier is `docs/effects/MultibandCompressor.md`; its Tier 2 rows are
...
The full Tier 2 sweeps live in `tools/phase2_probes/multiband_traits.py` --
...
RATE = 48000
CLASS = audioeffects.MultibandCompressor
...
class Traits(unittest.TestCase):
    ...
    `tools/phase2_probes/multiband_traits.py`."""
