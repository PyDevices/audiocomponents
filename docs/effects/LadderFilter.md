...
**Portability tier:** **needs audioif-own nodes** — one new node, for the
nonlinearity inside the feedback loop. The *linear* ladder turns out to be
reachable on stock biquads and is built that way (§4, §5).
**Status:** seed (Phase 0)
