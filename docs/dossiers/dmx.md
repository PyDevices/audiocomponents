...
| electrongate.com/dmxfiles (FAQ + 1554E page) | literature (facts only) | No license/terms statement found; hobbyist/commercial parts site, facts-only citation. **`http://` FAQ URL HTTP 404 this session; `https://www.electrongate.com/dmxfiles/dmxfiles_faq.html` reached (HTTP 200).** 1554E page reached. | http://www.electrongate.com/dmxfiles/dmxfiles_faq.html (**not reached**), https://www.electrongate.com/dmxfiles/dmx1554e.html (fetched this session) |
...
| elektrotanya.com search | literature (negative result) | n/a — **source not reached this session (HTTP 404).** Previously recorded as zero DMX-specific results. | https://elektrotanya.com/search.php?text=oberheim+dmx |
