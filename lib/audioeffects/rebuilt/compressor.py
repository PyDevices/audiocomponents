...
Rebuilt from scratch at Phase 2 against `docs/effects/Compressor.md`, whose
...
class Compressor(_component.Component):
    ...
    def _build(self, character="optical", patch=None, **overrides):
        ...
        wet_tap = self._own(split.tap(0), reset=False)
        dry_tap = self._own(split.tap(1), reset=False)
