...
Dossier: `docs/effects/BandPass.md`, traits frozen 2026-09-07.
Evidence:  `docs/effects/BandPass-evidence.md`.
"""
...
class BandPass(_component.Component):
    ...
    at DC and Nyquist, +-6 dB/octave skirts (+-12 with `Slope` on)."""
