...
`docs/effects/ParametricEQ.md`. The old `eq.py:ParametricEQ` is not
...
**Cost.** Eight sections, always built. On the ESP32-S3 the dossier budgets
43 % of one stereo block's real-time deadline for eight sections and 26 % on
the P4; the board run in the evidence pack is what settles it.
