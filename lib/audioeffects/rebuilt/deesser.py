...
Dossier: `docs/effects/DeEsser.md`. Evidence: `docs/effects/DeEsser-evidence.md`.
...
the only bound this palette can build (dossier N-DEESS-6).
"""
...
#: thing in both paths. Derivation: `docs/effects/DeEsser.md`, App. R from 4.
